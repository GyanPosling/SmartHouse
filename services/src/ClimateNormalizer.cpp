...
ClimateData ClimateNormalizer::normalize(ClimateData& currentData, vector<shared_ptr<SmartDevice>>& devices) {
...
bool ClimateNormalizer::analyzeAndRecommend(ClimateData& currentData, vector<shared_ptr<SmartDevice>>& devices) {
    ...
    if (co2 > ClimateData::MAX_CO2) {
        ...
        cout << "ℹ CO2 level is unusually low (" << co2 << " ppm). ";
